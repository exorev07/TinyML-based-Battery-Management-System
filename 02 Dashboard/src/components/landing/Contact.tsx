          ...
          {members.map((m, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Dock — pinned to card bottom, always visible */}
                <div style={{ position: 'absolute', bottom: '20px', left: 0, right: 0, display: 'flex', justifyContent: 'center' }}>
                  <Dock iconSize={30} iconMagnification={48} iconDistance={100} style={{ height: '42px', padding: '4px 12px', gap: '4px' }}>
                    {/* GitHub */}
                    <DockIcon>
                      <a href={m.github} target="_blank" rel="noopener noreferrer" title="GitHub" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', color: '#9ca3af', textDecoration: 'none' }}>
                        <svg viewBox="0 0 438.549 438.549" style={{ width: '100%', height: '100%' }}>
                    ...
                    {/* LinkedIn */}
                    <DockIcon>
                      <a href={m.linkedin} target="_blank" rel="noopener noreferrer" title="LinkedIn" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', color: '#9ca3af', textDecoration: 'none' }}>
                    ...
                    {/* Email */}
                    <DockIcon>
                      <a href={`mailto:${m.email}`} title="Send Email" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%', color: '#9ca3af', textDecoration: 'none' }}>
