...
class App {
  ...
  init() {
    if (!this.options.noPostProcessing) this.initPasses();
    const options = this.options;
    this.road.init();
  ...
  render(delta: number) {
    if (this.options.noPostProcessing) {
  ...
  dispose() {
    ...
    if (this.container && this.options.interactive !== false) {
